        ...
        if ($result = mysqli_query($link, $sql)) {
            if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    $cargiver_name1 = "SELECT a.first_name, roles.* FROM accounts a, roles WHERE a.role_id = roles.role_id and role_name = 'Caregiver' and a.patient_group = 1;";
                    ...
                    $cargiver_name2 = "SELECT a.first_name, roles.* FROM accounts a, roles WHERE a.role_id = roles.role_id and role_name = 'Caregiver' and a.patient_group = 2;";
                    ...
                    $cargiver_name3 = "SELECT a.first_name, roles.* FROM accounts a, roles WHERE a.role_id = roles.role_id and role_name = 'Caregiver' and a.patient_group = 3;";
                    ...
                    $cargiver_name4 = "SELECT a.first_name, roles.* FROM accounts a, roles WHERE a.role_id = roles.role_id and role_name = 'Caregiver' and a.patient_group = 4;";
